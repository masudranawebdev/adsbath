...
const Footer = () => {
  return (
    <div>
      <footer className="px-4 divide-y bg-gradient-to-r from-black to-purple-950 text-white">
        ...
        <div className="flex flex-col lg:flex-row justify-between py-10 mx-4 lg:mx-56">
          <div className="flex flex-col lg:flex-row gap-4 mb-4 lg:mb-0">
            <p>Copyright © 2023 AdsBath</p>
            <p>Design by Shanto</p>
          </div>
